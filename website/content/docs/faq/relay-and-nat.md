---
title: "Relay & NAT Traversal"
weight: 3
description: "How connections work: Circuit Relay v2, hole-punching, symmetric NAT, self-hosted relays."
---
<!-- Auto-synced from docs/faq/relay-and-nat.md by sync-docs - do not edit directly -->
...
![Home relay security layers: unauthenticated peers blocked at ConnectionGater (Layer 1), authorized peers pass through resource limits (Layer 2) and E2E encryption (Layer 3)](/images/docs/faq-relay-security-layers.svg)
...
![Decentralization path: from single VPS relay to peer relays to DHT discovery to fully distributed where every public peer relays for authorized peers](/images/docs/faq-decentralization-path.svg)
