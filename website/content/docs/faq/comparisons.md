...
title: "Comparisons"
weight: 2
description: "How different approaches to remote access compare: centralized VPNs, P2P mesh tools, relay architectures."
---
...
Shurli ships with 30 custom Prometheus metrics (proxy, auth, vault, pairing, deposits, admin socket) alongside libp2p built-in metrics, structured audit logging, and a pre-built Grafana dashboard with 37 panels out of the box. No other P2P tunnel tool ships with this level of built-in observability.
