...
> **Status: Planned (Phase 12)** - not yet implemented. See [Roadmap Phase 12](../roadmap/) for details.
...
> **Planned (Phase 10/15)**: The `NameResolver` interface, `DHTResolver`, multi-tier chaining, and blockchain naming are planned extensions. See [Naming System](#naming-system) below and [Roadmap Phase 15](../roadmap/).
...
![Poseidon2 Merkle tree: sorted leaves, power-of-2 padding, deterministic root](/images/docs/arch-zkp-merkle-tree.svg)
...
![ZKP challenge-response: client proves membership, relay verifies without learning identity](/images/docs/arch-zkp-auth-protocol.svg)
...
![Range proof: prove score >= threshold without revealing exact score](/images/docs/arch-zkp-range-proof.svg)
...
> **Status: Planned (Phase 14)** - not yet implemented. See [Federation Model](#federation-model) and [Roadmap Phase 14](../roadmap/).
...
> **Status: Planned (Phase 14)** - not yet implemented. See [Roadmap Phase 14](../roadmap/).
