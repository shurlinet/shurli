...
> **Relay server**: Both machines connect through a relay for NAT traversal. See [relay-server/README.md](../relay-setup/) for deploying your own. Run `peerup relay serve` to start a relay. A shared relay is used by default during development.
