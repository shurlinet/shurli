...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/transfer.go` (defense subsystem initialization, lines 660-780)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/transfer.go` (persistQueue, loadPersistedQueue, RequeuePersisted)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/share.go` (HandleBrowse, HandleDownload, LookupShareByID)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/transfer_resume.go` (bitfield), `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/transfer.go` (checkpoint save/load)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/share.go` (TransferQueue.Enqueue), `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/transfer.go` (runQueueProcessor cleanup ticker)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/share.go` (plugin registration), `https://github.com/shurlinet/shurli/blob/main/internal/relay/circuit_acl.go` (AllowConnect)
