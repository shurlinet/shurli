...
**Implementation**: `DHTProtocolPrefixForNamespace()` function in `https://github.com/satindergrewal/peer-up/blob/main/pkg/p2pnet/network.go` replaces direct use of the `DHTProtocolPrefix` constant at all 4 DHT bootstrap call sites. Config field: `discovery.network` (optional, validated as DNS-label format). `peerup init --network` and `peerup status` expose the namespace in the CLI.
...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/pkg/p2pnet/network.go:DHTProtocolPrefixForNamespace`, `https://github.com/satindergrewal/peer-up/blob/main/internal/config/config.go:DiscoveryConfig.Network`, `https://github.com/satindergrewal/peer-up/blob/main/internal/validate/network.go`
...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/internal/invite/pake.go`, `https://github.com/satindergrewal/peer-up/blob/main/internal/invite/pake_test.go`
...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/internal/invite/code.go`, `https://github.com/satindergrewal/peer-up/blob/main/cmd/peerup/cmd_invite.go`, `https://github.com/satindergrewal/peer-up/blob/main/cmd/peerup/cmd_join.go`
