...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/internal/daemon/server.go:86-138`
...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/internal/daemon/server.go:88-116`, `https://github.com/satindergrewal/peer-up/blob/main/internal/daemon/client.go`
...
- **Share a struct directly** - Import the runtime struct from cmd. Rejected because it creates a circular dependency between `https://github.com/satindergrewal/peer-up/blob/main/internal/daemon` and `cmd/peerup`.

**Decision**: `daemon.RuntimeInfo` interface with methods: `Network()`, `ConfigFile()`, `AuthKeysPath()`, `GaterForHotReload()`, `Version()`, `StartTime()`, `PingProtocolID()`, `ConnectToPeer()`. The `serveRuntime` struct in `https://github.com/satindergrewal/peer-up/blob/main/cmd/peerup/cmd_daemon.go` implements it.
...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/internal/daemon/server.go:23-32`, `https://github.com/satindergrewal/peer-up/blob/main/cmd/peerup/cmd_daemon.go:23-28`
...
**Reference**: `https://github.com/satindergrewal/peer-up/blob/main/cmd/peerup/cmd_daemon.go:37-51`, `https://github.com/satindergrewal/peer-up/blob/main/internal/auth/gater.go:74-79`
