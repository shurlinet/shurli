...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/proxy.go:66`
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/proxy.go:130-155`
...
**Decision**: Create real libp2p hosts in the same process, connecting through an in-process relay. Tests in `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/` create 2-3 hosts that communicate through circuit relay within a single test binary.
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/network_test.go`, `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/service_test.go`
