---
title: "Phase 9 - Relay Circuit Investigation"
weight: 29
description: "Tier-aware session limits (RC1), receiver busy retry (RC2), seed relay churn superseded by Grant Receipt Protocol (RC3)."
---
<!-- Auto-synced from docs/engineering-journal/relay-circuit-investigation.md by sync-docs - do not edit directly -->
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/plugins/filetransfer/transfer.go`
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/internal/grants/cache.go`, `https://github.com/shurlinet/shurli/blob/main/plugins/filetransfer/transfer_grants.go`
