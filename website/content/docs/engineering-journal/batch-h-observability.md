...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/metrics.go`, `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/network.go`
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/audit.go`, `https://github.com/shurlinet/shurli/blob/main/internal/daemon/middleware.go`, `https://github.com/shurlinet/shurli/blob/main/cmd/shurli/serve_common.go`

---

### ADR-H03: Auth Decision Callback (Avoiding Circular Imports)

**Context**: Auth decisions happen in `https://github.com/shurlinet/shurli/blob/main/internal/auth/gater.go`. Metrics live in `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/metrics.go`. Go forbids circular imports: `https://github.com/shurlinet/shurli/blob/main/internal/auth` cannot import `pkg/sdk`.

**Alternatives considered**:
- **Move gater to pkg/sdk** - Would work but breaks the `https://github.com/shurlinet/shurli/blob/main/internal/` boundary. The gater is an internal implementation detail.
