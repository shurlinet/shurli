...
| [FT-Y: TCP-for-LAN Experiment](tcp-for-lan-experiment/) | ADR-TL01 to ADR-TL07 | Negative-result experiment proving that TCP plus yamux does not beat QUIC for Shurli LAN bulk transfers on macOS |
| [Phase 11: Post-Quantum Cryptography](phase11-post-quantum-cryptography/) | ADR-PQ01 to ADR-PQ06 | Dual-layer PQ strategy, go-clatter, transport integration, policy enforcement, PQC status, ML-DSA-65 signing |
