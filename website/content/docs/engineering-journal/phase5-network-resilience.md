...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/mdns_browse_native.go`, `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/mdns_browse_fallback.go`, `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/mdns.go`
...
- **Callback bridge**: `ConnectionRecorder` callback bridges `pkg/sdk` to `https://github.com/shurlinet/shurli/blob/main/internal/reputation` without import cycles.
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/peermanager.go` (constants, `PeerManager`, `ManagedPeer`, `reconnectLoop`, `attemptReconnect`)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/peermanager.go` (`CloseStaleConnections`, `extractIPFromMultiaddrObj`), `https://github.com/shurlinet/shurli/blob/main/cmd/shurli/serve_common.go` (wiring)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/peermanager.go` (`reconnectNow` field, `OnNetworkChange`, `reconnectLoop`)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/peermanager.go` (`ProbeAndUpgradeRelayed`, `probeAndUpgrade`, `probeLoop`, `closeRelayConns`)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/mdns.go` (`filterLANAddrs`, `localIPv4Subnets`, `HandlePeerFound`)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/peermanager.go` (`attemptReconnect` relay-discard block), `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/mdns.go` (relay sweep goroutine)
...
**Reference**: `https://github.com/shurlinet/shurli/blob/main/pkg/sdk/stunprober.go` (`DetectCGNAT`), `https://github.com/shurlinet/shurli/blob/main/cmd/shurli/serve_common.go` (passes config flag), `https://github.com/shurlinet/shurli/blob/main/internal/config/config.go` (`NetworkConfig.ForceCGNAT`)
