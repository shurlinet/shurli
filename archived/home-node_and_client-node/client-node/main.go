...
func main() {
	...
	// Method 2: If rendezvous didn't work, try direct DHT lookup
	if targetAddrInfo == nil {
		...
		if err != nil {
			...
			fmt.Println("register with the DHT (give it at least 2 minutes).")
			os.Exit(1)
		}
		targetAddrInfo = &pi
		fmt.Println("✅ Found home node via DHT lookup!")
	}
