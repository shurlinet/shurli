...
func TestNodeConfigTemplate(t *testing.T) {
	...
	generator := "shurli init"

	output := nodeConfigTemplate([]string{relayAddr}, generator, "")
	...
	checks := []struct {
		...
		{"has generator comment", "Generated by: shurli init"},
		{"has rendezvous", `rendezvous: "shurli-default-network"`},
...
func TestNodeConfigTemplateDifferentInputs(t *testing.T) {
	...
	t.Run("network namespace included when set", func(t *testing.T) {
		out := nodeConfigTemplate([]string{"/ip4/1.2.3.4/tcp/7777/p2p/12D3KooWTest"}, "shurli init", "my-crew")
	...
	t.Run("network namespace omitted when empty", func(t *testing.T) {
		out := nodeConfigTemplate([]string{"/ip4/1.2.3.4/tcp/7777/p2p/12D3KooWTest"}, "shurli init", "")
