...
func TestNodeConfigTemplateDifferentInputs(t *testing.T) {
	t.Run("different relay addr", func(t *testing.T) {
		out := nodeConfigTemplate("/ip6/::1/tcp/9999/p2p/12D3KooWXYZ", "shurli join", "")
	...
	t.Run("network namespace included when set", func(t *testing.T) {
		out := nodeConfigTemplate("/ip4/1.2.3.4/tcp/7777/p2p/12D3KooWTest", "shurli init", "my-crew")
	...
	t.Run("network namespace omitted when empty", func(t *testing.T) {
		out := nodeConfigTemplate("/ip4/1.2.3.4/tcp/7777/p2p/12D3KooWTest", "shurli init", "")
