...
**Reference**: `internal/macaroon/macaroon.go`
...
**Reference**: `internal/grants/store.go`, `internal/grants/pouch.go`
...
**Reference**: `internal/macaroon/caveat.go`, `internal/grants/pouch.go` (Delegate method)
...
**Reference**: `internal/grants/audit.go`
...
**Reference**: `internal/grants/rate_limit.go`
