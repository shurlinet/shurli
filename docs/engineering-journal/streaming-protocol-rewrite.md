# FT-Y: Streaming Protocol Rewrite
...
**Reference**: `plugins/filetransfer/transfer.go`, `plugins/filetransfer/transfer_stream.go`, `plugins/filetransfer/transfer_parallel.go`
...
**Reference**: `plugins/filetransfer/transfer.go`, `plugins/filetransfer/transfer_stream.go`, `plugins/filetransfer/transfer_resume.go`
...
**Reference**: `plugins/filetransfer/transfer_stream.go`, `plugins/filetransfer/transfer.go`
...
**Reference**: `plugins/filetransfer/transfer_parallel.go`, `plugins/filetransfer/transfer.go`, `plugins/filetransfer/transfer_stream.go`
...
**Reference**: `plugins/filetransfer/share.go`, `plugins/filetransfer/transfer.go`
...
**Reference**: `plugins/filetransfer/compress.go`, `plugins/filetransfer/transfer_stream.go`, `plugins/filetransfer/transfer.go`
...
**Reference**: `plugins/filetransfer/chunker.go`, `plugins/filetransfer/transfer.go`, `plugins/filetransfer/transfer_parallel.go`, `plugins/filetransfer/transfer_resume.go`
...
**Reference**: `plugins/filetransfer/transfer_resume.go`, `plugins/filetransfer/transfer_stream.go`, `plugins/filetransfer/transfer.go`
...
**Reference**: `plugins/filetransfer/compress.go`, `plugins/filetransfer/transfer.go`, `plugins/filetransfer/plugin.go`, `pkg/sdk/plugin_policy.go`
