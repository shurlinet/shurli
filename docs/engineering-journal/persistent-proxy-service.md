...
Code verification confirmed the lifecycle split. `cmd/shurli/cmd_proxy.go` still supports ephemeral foreground proxying, while persistent subcommands call daemon API methods in `internal/daemon/client.go`. Commit 42c8655 changed 13 files with 1360 insertions and 22 deletions, centered on daemon API, store, server lifecycle, CLI, completions, man page, and SDK proxy behavior.

**Reference**: `cmd/shurli/cmd_proxy.go`, `internal/daemon/client.go`, `internal/daemon/handlers.go`, `internal/daemon/server.go`
...
Persist desired proxy state in `proxies.json` through `internal/daemon/proxy_store.go`.
...
**Reference**: `internal/daemon/proxy_store.go`, `internal/daemon/server.go`, `cmd/shurli/cmd_daemon.go`, `cmd/shurli/cmd_proxy.go`
...
**Reference**: `cmd/shurli/serve_common.go`, `internal/daemon/server.go`, `pkg/sdk/proxy.go`
...
**Reference**: `cmd/shurli/serve_common.go`, `internal/daemon/server.go`, `pkg/sdk/peermanager.go`
...
**Reference**: `pkg/sdk/proxy.go`, `internal/daemon/server.go`, `internal/daemon/handlers.go`, `internal/daemon/types.go`
