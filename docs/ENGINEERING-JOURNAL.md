...
This document has been split into per-batch files for easier navigation. See the [engineering-journal/](engineering-journal/) directory:

- [README.md](engineering-journal/README.md) - Index and reading guide
- [Core Architecture](engineering-journal/core-architecture.md) - ADR-001 to ADR-008
- [Batch A: Reliability](engineering-journal/batch-a-reliability.md) - ADR-A01 to ADR-A04
- [Batch B: Code Quality](engineering-journal/batch-b-code-quality.md) - ADR-B01 to ADR-B04
- [Batch C: Self-Healing](engineering-journal/batch-c-self-healing.md) - ADR-C01 to ADR-C03
- [Batch D: libp2p Features](engineering-journal/batch-d-libp2p-features.md) - ADR-D01 to ADR-D04
- [Batch E: New Capabilities](engineering-journal/batch-e-new-capabilities.md) - ADR-E01 to ADR-E02
- [Batch F: Daemon Mode](engineering-journal/batch-f-daemon-mode.md) - ADR-F01 to ADR-F04
...
- [Post-I-2: Trust & Delivery](engineering-journal/post-i-2-trust-and-delivery.md) - ADR-J01 to ADR-J06
- [Pre-Phase 5 Hardening](engineering-journal/pre-phase5-hardening.md) - ADR-K01 to ADR-K03
