...
![Monitoring stack - peer-up nodes scraped by Prometheus, visualized in Grafana](images/monitoring-stack.svg)
...
You'll immediately see the dashboard with 16 panels across 5 sections.
